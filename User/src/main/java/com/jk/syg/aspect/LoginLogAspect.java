package com.jk.syg.aspect;

import com.alibaba.fastjson.JSON;
import com.jk.MyLog;
import com.jk.syg.bean.LogLogin;
import com.jk.syg.util.IpUtils;
...
private MongoTemplate mongoTemplate;
    ...
    public void saveSysLog(JoinPoint joinPoint) {
        ...
        Object phoneNumber = redisTemplate.opsForValue().get("currentUser");
        String phoneNum = phoneNumber.toString();
        logLogin.setUsername(phoneNum);
        //获取用户ip地址
